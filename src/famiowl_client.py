...
"")
        ...
        self.switch_child_widget = QtWidgets.QWidget(self.switch_child_frame)
        self.switch_child_widget.setStyleSheet("image: url(:/buttom/img/buttom/切换_switch.svg);\n"
"border-radius:32px;\n"
"background-color: transparent;")
        self.switch_child_widget.setObjectName("switch_child_widget")
        self.horizontalLayout.addWidget(self.switch_child_widget)
