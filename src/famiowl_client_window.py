...
class Ui_FamiOwl(object):
    def setupUi(self, FamiOwl):
        ...
        item = QtWidgets.QListWidgetItem()
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/buttom/img/buttom/商店_shop.svg"), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        item.setIcon(icon1)
        self.menu_listwidget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/buttom/img/buttom/打开_open-one.svg"), QtGui.QIcon.Mode.Normal,
                        QtGui.QIcon.State.Off)
        item.setIcon(icon2)
        self.menu_listwidget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        ...
        self.search_game_line.setAlignment(
